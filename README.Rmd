...
The Barbie theme (`theme_barbie()`) has been one of the most popular themes from `ThemePark`.
...
```
### APA:
Jané, M.B., Pilling, Luke C., & Kenny, Christopher T. (2023). theme_park: popular culture ggplot themes (Version 0.0.1) [Source Code]. https://github.com/MatthewBJane/theme_park
