...
theme_alien <- function(alien_font = TRUE, ...){
  ...
  font_family = ifelse(alien_font,"alien","sans") # use this line if you have a custom font
  if (alien_font) {
    initialize_font(name="Archivo Black", family="alien")    # Alternatives: "Roboto Condensed" "Anton"
  }
